...
import { drinkList } from "../dataSet/drink";
...
export function DrinkList (props) {
   ...
   return (
      <div id="drink" className="xl:w-[1300px] lg:w-[1000px] md:w-[800px] sm:w-[550px] w-[300px] m-auto">
         <div className="font-opensans flex md:mt-20 mt-10 ">
            <div id="pizza_1" className="flex justify-start md:text-5xl text-6xl ml-5">Напитки</div>
         </div>
         ...
         {drinkList.map(item => (
               <Drink key={item.id} handlBuy={handlBuy} {...item} />
            ))}
         </div>
